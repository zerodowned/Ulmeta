...
namespace Server.Mobiles
{
	public class CustomHairstylist : BaseVendor
	{
		...
		private static HairstylistBuyInfo[] m_SellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( 1018357, 1000, false, typeof( ChangeHairstyleGump ), new object[]
					{ From, Vendor, Price, false, ChangeHairstyleEntry.HairEntries } ),
				new HairstylistBuyInfo( 1018358, 1000, true, typeof( ChangeHairstyleGump ), new object[]
				...
				new HairstylistBuyInfo( 1018360, 5000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.BrightEntries } ),
				new HairstylistBuyInfo( 1018361, 500, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, false, ChangeHairHueEntry.RegularEntries } ),
				new HairstylistBuyInfo( 1018362, 500, true, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, false, true, ChangeHairHueEntry.RegularEntries } ),
				new HairstylistBuyInfo( 1018363, 5500, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, false, ChangeHairHueEntry.BrightEntries } ),
				new HairstylistBuyInfo( 1018364, 5500, true, typeof( ChangeHairHueGump ), new object[]
