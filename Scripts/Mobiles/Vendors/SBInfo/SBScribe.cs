	...
	public class SBScribe: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
                ...
                Add(new GenericBuyInfo("1041267", typeof(Runebook), Utility.Random(4000, 5000), 5, 0xEFA, 0x461));

                Add(new GenericBuyInfo("Gem-Tipped Chisel", typeof(GemTippedChisel), Utility.Random(14000, 15000), 30, 4787, 0));
                Add(new GenericBuyInfo("A Branding Iron", typeof(BrandingIron), Utility.Random(14000, 15000), 30, 4024, 0));
			}
		}
