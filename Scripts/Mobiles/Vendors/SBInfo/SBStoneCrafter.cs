	...
	public class SBStoneCrafter : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( "Making Valuables With Stonecrafting", typeof( MasonryBook ), 350, 10, 0xFBE, 0 ) );
				Add( new GenericBuyInfo( "Mining For Quality Stone", typeof( StoneMiningBook ), 300, 10, 0xFBE, 0 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			{
				Add( typeof( MasonryBook ), 150 );
				Add( typeof( StoneMiningBook ), 125 );
