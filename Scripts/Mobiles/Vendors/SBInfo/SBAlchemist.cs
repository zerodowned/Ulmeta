	...
	public class SBAlchemist : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( NightSightPotion ), 15 );
				Add( typeof( AgilityPotion ), 15 );
				Add( typeof( StrengthPotion ), 15 );
				Add( typeof( RefreshPotion ), 15 );
				Add( typeof( LesserCurePotion ), 15 );
				Add( typeof( LesserHealPotion ), 15 );
				Add( typeof( LesserPoisonPotion ), 15 );
				Add( typeof( LesserExplosionPotion ), 15 );
				Add( typeof( CurePotion ), 22 );
				Add( typeof( HealPotion ), 22 );
				Add( typeof( PoisonPotion ), 22 );
				Add( typeof( ExplosionPotion ), 22 );
			}
		}
	}
}
