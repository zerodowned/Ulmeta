    ...
    public abstract class BaseVendor : BaseCreature, IVendor
    {
        ...
        public virtual void InitOutfit()
        {
            switch( Utility.Random(2) )
            {
                ...
                case 1: AddItem(new Shirt(GetRandomHue())); break;
            }
            ...
            if( Female )
            {
                switch( Utility.Random(6) )
                {
                    ...
                    case 1:
                    case 2: AddItem(new PlainDress(GetRandomHue())); break;
                    case 3:
                    case 4:
        ...
        private void ProcessValidPurchase( int amount, IBuyItemInfo bii, Mobile buyer, Container cont )
        {
            ...
            if( buyer.Player )
            {
                EventDispatcher.InvokeItemPurchased(new ItemPurchasedEventArgs((Player)buyer, o));
            }
        }
        ...
        public virtual bool OnBuyItems( Mobile buyer, List<BuyItemResponse> list )
        {
            ...
            cont = buyer.Backpack;
            Type[] currencyTypes = CurrencySystem.AllCurrencies;
            int[] compressedCost = CurrencySystem.Compress(totalCost, 0, 0);
            ...
            if( !bought && totalCost >= 2000 )
            {
                ...
                if( cont != null && cont.ConsumeTotal(currencyTypes, compressedCost) == -1 )
                {
                    bought = true;
                    fromBank = true;
                }
            ...
            foreach( SellItemResponse resp in list )
            {
                ...
                foreach( IShopSellInfo ssi in info )
                {
                    if( ssi.IsSellable(resp.Item) )
                    {
                        if( seller.Player )
                        {
                            EventDispatcher.InvokeItemSold(new ItemSoldEventArgs((Player)seller, resp.Item));
                        }
