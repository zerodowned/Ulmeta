...
namespace Server.Mobiles
{
    public class MageAI : BaseAI
    {
        ...
        {
            get { return true; }// (m_Mobile is BaseVendor || m_Mobile is BaseEscortable); }
        }

        private const double HealChance = 0.05; // 5% chance to heal at gm magery
        ...
        public override bool DoActionWander()
        {
            ...
            else if( SmartAI && m_Mobile.Mana < (m_Mobile.ManaMax / 2) )
            {
        ...
        public virtual Spell GetRandomDamageSpell()
        {
            ...
            switch( Utility.Random(maxCircle * 2) )
            {
                ...
                case 12: return new MeteorSwarmSpell(m_Mobile, null);
                case 13: return new PoisonFieldSpell(m_Mobile, null);
