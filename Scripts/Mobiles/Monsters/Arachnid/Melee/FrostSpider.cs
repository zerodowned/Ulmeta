...
namespace Server.Mobiles
{
	...
	public class FrostSpider : BaseCreature
	{
		...
		public FrostSpider() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetDamageType( ResistanceType.Physical, 5, 20 );
			SetDamageType( ResistanceType.Cold, 80, 120 );

			SetResistance( ResistanceType.Physical, 25, 80 );
			SetResistance( ResistanceType.Fire, 25, 60 );
			SetResistance( ResistanceType.Cold, 40, 70 );
			SetResistance( ResistanceType.Poison, 20, 80 );
			SetResistance( ResistanceType.Energy, 10, 90 );

			SetSkill( SkillName.MagicResist, 25.1, 140.0 );
			SetSkill( SkillName.Tactics, 35.1, 150.0 );
			SetSkill( SkillName.Wrestling, 50.1, 165.0 );
