...
namespace Server.Mobiles
{
	...
	public class MoundOfMaggots : BaseCreature
	{
		...
		public MoundOfMaggots() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetDamageType( ResistanceType.Poison, 50, 80 );

			SetResistance( ResistanceType.Physical, 90 );
			SetResistance( ResistanceType.Poison, 100 );

			SetSkill( SkillName.Tactics, 100.0, 120 );
			SetSkill( SkillName.Wrestling, 50.1, 120.0 );
            SetSkill(SkillName.Magery, 40.9, 70);
            SetSkill(SkillName.Meditation, 7, 45);
            SetSkill(SkillName.MagicResist, 20, 48);
