...
namespace Server.Mobiles
{
    ...
    public class OrcCaptain : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetResistance(ResistanceType.Physical, 50, 105);
            SetResistance(ResistanceType.Fire, 45, 100);
            SetResistance(ResistanceType.Cold, 67, 105);
            SetResistance(ResistanceType.Poison, 49, 100);
            SetResistance(ResistanceType.Energy, 50, 100);

            SetSkill(SkillName.MagicResist, 70.1, 125.0);
            SetSkill(SkillName.Swords, 70.1, 105.0);
