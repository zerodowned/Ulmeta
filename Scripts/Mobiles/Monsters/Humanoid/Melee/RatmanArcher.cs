...
namespace Server.Mobiles
{
	...
	public class RatmanArcher : BaseCreature
	{
		...
		public RatmanArcher() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Physical, 40, 85 );
			...
			SetSkill( SkillName.Anatomy, 60.2, 120.0 );
			SetSkill( SkillName.Archery, 80.1, 120.0 );
			SetSkill( SkillName.MagicResist, 65.1, 120.0 );
			SetSkill( SkillName.Tactics, 50.1, 105.0 );
			SetSkill( SkillName.Wrestling, 50.1, 105.0 );
