	...
	public class Gambler : BaseCreature
	{
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			if( from.InRange( this, 4 ) )
			{
				...
				if( e.Speech.ToLower() == "hello" || e.Speech.ToLower() == "hi" || e.Speech.ToLower() == "gambler" || e.Speech.ToLower() == "hail" )
				{
					message = "Let's play a game of cards.";
					this.Say( message );
				}
				else if( e.Speech.ToLower() == "play" )
				{
					message = "Would you like to play a game of cards?";
					this.Say( message );
				}
