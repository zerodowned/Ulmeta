...
namespace Server.Mobiles
{
	...
	public class MaleOstard : BaseMount
	{
		[Constructable]
		public MaleOstard() : this( "a male ostard" )
		{
		}

		[Constructable]
		public MaleOstard( string name ) : base( name, 0xDA, 0x3EA4, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public MaleOstard( Serial serial ) : base( serial )
		{
		}
