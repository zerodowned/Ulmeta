...
namespace Server.Mobiles
{
	...
	public class ForestWyrm : BaseMount
	{
		...
		[Constructable]
		public ForestWyrm() : this( "a forest wyrm" )
		{
		}
		...
		public ForestWyrm( string name ) : base( name, 0x31A, 0x3EBD, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.MagicResist, 145.1, 155.0 );
		...
		public ForestWyrm( Serial serial ) : base( serial )
		{
		}
