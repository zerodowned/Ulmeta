...
{
	public abstract class Champion : BaseCreature
	{
		public override bool CanMoveOverObstacles { get { return true; } }
		public override bool CanDestroyObstacles { get { return true; } }

		public Champion( AIType aiType ) : this( aiType, FightMode.Closest )
		{
		}

		public Champion( AIType aiType, FightMode mode ) : base( aiType, mode, 18, 1, 0.1, 0.2 )
		{
		}
        ...
        public override bool Unprovokable
        {
            get
            {
                return base.Unprovokable;
            }
        }

		public virtual bool NoGoodies{ get{ return true; } }
		...
		{
			return PowerScroll.CreateRandom( 5, 25 );
		}
