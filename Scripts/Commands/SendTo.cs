...
namespace Server.Commands
{
	public class SendTo
	{
		...
		private class SendToTarget : Target
		{
			...
			public SendToTarget( Point3D p, Map m )
		...
		public class SendToGump : Gump
		{
			...
			public static readonly LocationTree Backtrol = new LocationTree( "backtrol.xml", Map.Backtrol );
