			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup(  800, new RewardItem( 15, PowderOfTemperament ), new RewardItem( 1, ColoredAnvil ) ),
					new RewardGroup(  850, new RewardItem( 1, AncientHammer, 15 ) ),
					new RewardGroup(  900, new RewardItem( 1, AncientHammer, 20 ) ),
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup( 500, new RewardItem( 6, Cloth, 4 ), new RewardItem( 1, StretchedHide ) ),
					new RewardGroup( 550, new RewardItem( 1, ClothingBlessDeed ) ),
					new RewardGroup( 575, new RewardItem( 1, RunicKit, 1 ) ),
					new RewardGroup( 600, new RewardItem( 1, RunicKit, 2 ) ),
					new RewardGroup( 650, new RewardItem( 1, BearRug ) ),
