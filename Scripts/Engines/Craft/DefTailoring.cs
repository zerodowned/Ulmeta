...
namespace Server.Engines.Craft
{
    public class DefTailoring : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            AddCraft(typeof(LeatherBelt), 1015283, "leather belt", 70.0, 105.0, typeof(Leather), 1044462, 4, 1044463);
            AddCraft(typeof(Pouch), 1015283, "pouch", 5.0, 10.0, typeof(Leather), 1044462, 2, 1044463);
            AddCraft(typeof(Bag), 1015283, "bag", 5.0, 10.0, typeof(Leather), 1044462, 3, 1044463);
            AddCraft(typeof(Backpack), 1015283, "backpack", 5.0, 10.0, typeof(Leather), 1044462, 4, 1044463);
            AddCraft(typeof(Bedroll), 1015283, "bedroll", 87.0, 95.0, typeof(Cloth), 1044462, 4, 1044463);
            ...
            AddCraft(typeof(CarpetAddonDeed), 1015283, "carpeting", 82.4, 99.9, typeof(Cloth), 1044286, 45, 1044287);
            #endregion
            ...
            index = AddCraft(typeof(HitchingRope), 1015283, "hitching rope", 90.0, 110.0, typeof(Leather), "Leather or Hides", 10, 1044463);
            AddRes(index, typeof(Rope), "Rope", 2, "You do not have enough rope.");
