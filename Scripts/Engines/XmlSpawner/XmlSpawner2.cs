...
namespace Server.Mobiles
{
	...
	public class XmlSpawner : Item, ISpawner
	{
		...
		private const int ShowBoundsItemId = 8708;             // 14089 Fire Column // 3555 Campfire // 8708 Skull Pole
		...
		public static AccessLevel SmartSpawnAccessLevel = AccessLevel.Counselor;
...
public static void _TraceEnd(int index)
{
	   if(index < MaxTraces){
		...
		public bool CanFit( int x, int y, int z, int height, bool checkBlocksFit, bool checkMobiles, bool requireSurface, Mobile mob )
		{
			...
			TileFlag landFlags = TileData.LandTable[lt.ID].Flags;
			...
			{
				ItemData id = TileData.ItemTable[staticTiles[i].ID];
				surface = id.Surface;
