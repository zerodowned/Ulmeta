...
namespace Server.RemoteAdmin
{
	public class RemoteAdminHandlers
	{
		...
		{
			return beholder.AccessLevel == AccessLevel.Administrator || beheld.AccessLevel < beholder.AccessLevel;  // Cannot see accounts of equal or greater access level unless Owner
		}
