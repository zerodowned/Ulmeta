...
namespace Server.Engines.Harvest
{
	public class Fishing : HarvestSystem
	{
		...
		private static MutateEntry[] m_MutateTable = new MutateEntry[]
			{
				new MutateEntry(  80.0,  80.0,  480.0,  true, typeof( SpecialFishingNet ) ),
				new MutateEntry(  80.0,  80.0,  480.0,  true, typeof( BigFish ) ),
				new MutateEntry(  90.0,  80.0,  480.0,  true, typeof( TreasureMap ) ),
				new MutateEntry( 100.0,  80.0,  480.0,  true, typeof( MessageInABottle ) ),
		...
		public override Item Construct( Type type, Mobile from )
		{
			if( type == typeof( TreasureMap ) )
			{
				...
				return new TreasureMap( level, from.Map );
			}
		...
		//exposed for BaseBoat.SwabDecks()
		public static int[] WaterTiles { get { return m_WaterTiles; } }
	}
}