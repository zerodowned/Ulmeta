	...
	public class Lumberjacking : HarvestSystem
	{
		...
		private Lumberjacking()
		{
			...
			else
			{
				...
				{
					new HarvestResource(  00.0, 00.0, 100.0, 1072540, typeof( Log ) ),
					new HarvestResource(  65.0, 25.0, 100.0, 1072541, typeof( OakLog ) ),
					new HarvestResource(  80.0, 40.0, 100.0, 1072542, typeof( AshLog ) ),
					new HarvestResource(  95.0, 55.0, 100.0, 1072543, typeof( YewLog ) ),
				};

				veins = new HarvestVein[]
				{
					new HarvestVein( 55.0, 0.0, res[0], null ),	// Ordinary Logs
					new HarvestVein( 30.0, 0.5, res[1], res[0] ), // Oak
					new HarvestVein( 10.0, 0.5, res[2], res[0] ), // Ash
					new HarvestVein( 05.0, 0.5, res[3], res[0] ), // Yew
				};
