...
namespace Server.Engines.Harvest
{
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			string GemMessage = "You find a gem in the ore!";
			oreAndStone.BonusResources = new BonusHarvestResource[]
				{
					new BonusHarvestResource( 50.0, 2.0, GemMessage, typeof( Amber ) ),
					new BonusHarvestResource( 50.0, 2.0, GemMessage, typeof( Tourmaline ) ),
					new BonusHarvestResource( 70.0, 2.0, GemMessage, typeof( Amethyst ) ),
					new BonusHarvestResource( 70.0, 2.0, GemMessage, typeof( Ruby ) ),
					new BonusHarvestResource( 85.0, 2.0, GemMessage, typeof( Sapphire ) ),
					new BonusHarvestResource( 95.0, 2.0, GemMessage, typeof( Emerald ) ),
					new BonusHarvestResource( 100.0, 2.0, GemMessage, typeof( Diamond ) )
				};
			...
			res = new HarvestResource[]
				{
					new HarvestResource( 100.0, 70.0, 300.0, 1044631, typeof( Sand ) )
				};
			...
			sand.BonusResources = new BonusHarvestResource[]
				{
					new BonusHarvestResource( 75.0, 5.0, "You unearth a rib cage!", typeof( RibCage ) ),
					new BonusHarvestResource( 90.0, 5.0, "You unearth a rare blue gem!", typeof( StarSapphire ) ),
					new BonusHarvestResource( 100.0, 0.5, "You unearth an old wooden chest!", typeof( WoodenTreasureChest ) )
				};
