        ...
        private static TravelValidator[] m_Validators = new TravelValidator[]
			{
				...
				new TravelValidator( IsTown )
			};

        private static bool[,] m_Rules = new bool[,]
			{
					/*T2A(Fel)		Ilshenar		Wind(Tram),	Wind(Fel),	Dungeons(Fel),	Town*/
/* Recall From */	{ true,			true,			true,		true,		true,			true },
/* Recall To */		{ true,			true,			true,		true,		true,			true },
/* Gate From */		{ true,			true,			true,		true,		true,			true },
/* Gate To */		{ true,			true,			true,		true,		true,			true },
/* Mark In */		{ true,			true,			true,		true,		true,			false },
/* Tele From */		{ true,			true,			true,		true,		true,			true },
/* Tele To */		{ true,			true,			true,		true,		true,			true },
			};
        ...
        public static bool IsTown( Map map, Point3D loc )
        {
            Region region = Region.Find(loc, map);

            return (region != null && region is TownRegion);
        }
    ...
    public class TransformationSpellHelper
    {
        ...
        public static bool OnCast( Mobile caster, Spell spell )
        {
            ...
            else if( !caster.CanBeginAction(typeof(Spells.Fifth.IncognitoSpell)) || (caster.IsBodyMod && GetContext(caster) == null) )
            {
                spell.DoFizzle();
            }
