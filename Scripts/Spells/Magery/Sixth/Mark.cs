...
namespace Server.Spells.Sixth
{
	public class MarkSpell : MagerySpell
	{
		...
		public void Target( RecallRune rune )
		{
            ...
            else if (!CheckAltar(Caster.Location, Caster.Map) && Caster.AccessLevel == AccessLevel.Player)
            {
                Caster.SendMessage("You must be on an altar to preform this spell.");
            }

            else if (!rune.IsChildOf(Caster.Backpack) && Caster.AccessLevel == AccessLevel.Player)
            {
