...
namespace Server.Misc
{
	public class AutoRestart : Timer
	{
		...
		private static TimeSpan RestartTime = TimeSpan.FromHours( 4.5 ); // time of day at which to restart
		private static TimeSpan RestartDelay = TimeSpan.FromMinutes( 10.0 ); // how long the server should remain active before restart (period of 'server wars')

		private static TimeSpan WarningDelay = TimeSpan.FromMinutes( 2.0 ); // at what interval should the shutdown message be displayed?
