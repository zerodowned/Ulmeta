...
namespace Server.Items
{
	...
	{
		private int m_PackWeight;

		public virtual int PackWeight { get { return m_PackWeight; } set { m_PackWeight = value; } }
		public override int DefaultMaxWeight { get { return m_PackWeight; } }
			...
			: base( 0xE75 )
		{
			...
			m_PackWeight = Container.GlobalMaxWeight;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if( version >= 2 )
				m_PackWeight = reader.ReadInt();

			if( DefaultMaxWeight <= 0 )
				UpdateWeight( Container.GlobalMaxWeight );
		}
	}
