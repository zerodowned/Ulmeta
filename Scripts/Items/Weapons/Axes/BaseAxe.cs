...
namespace Server.Items
{
    public abstract class BaseAxe : BaseMeleeWeapon, IUsesRemaining
    {
        ...
        public override void OnHit( Mobile attacker, Mobile defender, double damageBonus )
        {
            ...
            if( !Core.SE && (attacker.Player || attacker.Body.IsHuman) && Layer == Layer.TwoHanded && (attacker.Skills[SkillName.Anatomy].Value / 1000.0) >= Utility.RandomDouble() )
            {
                ...
                if( mod == null )
                {
                    ...
                    defender.AddStatMod(new StatMod(StatType.Int, "Concussion", -(defender.RawInt / 4), TimeSpan.FromSeconds(6.0)));
