...
namespace Server.Items
{
	public class CarpetAddon : BaseAddon
	{
		...
		public CarpetAddon( Serial serial )
			: base( serial )
		{
		}
		#endregion
...
/* Plain1 */		new CarpetInfo( new ItemPart[] { 
						new ItemPart( 0xAAE, Position.Top, 30, 0 ),
						new ItemPart( 0xAB0, Position.Bottom, 30, 59 ),
						new ItemPart( 0xAB1, Position.Left, 1, 30 ),
						new ItemPart( 0xAAF, Position.Right, 60, 30 ),
						new ItemPart( 0xAAD, Position.West, 18, 12 ),
						new ItemPart( 0xAAA, Position.North, 40, 10 ),
						new ItemPart( 0xAAB, Position.East, 45, 45 ),
						new ItemPart( 0xAAC, Position.South, 22, 50 ),
						new ItemPart( 0xAA9, Position.Center, 44, 28 )
					}),
/* Plain2 */		new CarpetInfo( new ItemPart[] { 
						new ItemPart( 0x109D, Position.Top, 30, 0 ),
						new ItemPart( 0x109F, Position.Bottom, 30, 59 ),
						new ItemPart( 0x10A0, Position.Left, 1, 30 ),
						new ItemPart( 0x109E, Position.Right, 60, 30 ),
						new ItemPart( 0x109C, Position.West, 18, 12 ),
						new ItemPart( 0x1099, Position.North, 40, 10 ),
						new ItemPart( 0x109A, Position.East, 45, 45 ),
						new ItemPart( 0x109B, Position.South, 22, 50 ),
						new ItemPart( 0x1098, Position.Center, 44, 28 )
					}),	
/* Plain3 */		new CarpetInfo( new ItemPart[] { 
						new ItemPart( 0x1DEB, Position.Top, 30, 0 ),
						new ItemPart( 0x1DDF, Position.Bottom, 30, 59 ),
						new ItemPart( 0x1DE0, Position.Left, 1, 30 ),
						new ItemPart( 0x1DDE, Position.Right, 60, 30 ),
						new ItemPart( 0x1DDB, Position.West, 18, 12 ),
						new ItemPart( 0x1DD5, Position.North, 40, 10 ),
						new ItemPart( 0x1DD7, Position.East, 45, 45 ),
						new ItemPart( 0x1DD9, Position.South, 22, 50 ),
						new ItemPart( 0x1DD3, Position.Center, 44, 28 )
					}),	
/* Plain4 */		new CarpetInfo( new ItemPart[] { 
						new ItemPart( 0x1DF9, Position.Top, 30, 0 ),
						new ItemPart( 0x1DFB, Position.Bottom, 30, 59 ),
						new ItemPart( 0x1DFC, Position.Left, 1, 30 ),
						new ItemPart( 0x1DFA, Position.Right, 60, 30 ),
						new ItemPart( 0x1DF7, Position.West, 18, 12 ),
						new ItemPart( 0x1DF1, Position.North, 40, 10 ),
						new ItemPart( 0x1DF3, Position.East, 45, 45 ),
						new ItemPart( 0x1DF5, Position.South, 22, 50 ),
						new ItemPart( 0x1DEF, Position.Center, 44, 28 )
					}),
