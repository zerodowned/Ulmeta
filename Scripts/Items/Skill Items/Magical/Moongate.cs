...
namespace Server.Items
{
	...
	public class Moongate : Item
	{
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool Dispellable { get { return m_bDispellable; } set { m_bDispellable = value; } }

		[CommandProperty( AccessLevel.GameMaster, AccessLevel.Administrator + 1 )]
		public Moongate PairedGate { get { return _pairedGate; } set { _pairedGate = value; } }
		...
		public override void OnAfterDelete()
		{
			...
			if( PairedGate != null && !PairedGate.Deleted )
				PairedGate.Delete();
		}
		...
		public virtual void UseGate( Mobile m )
		{
			...
			if ( (m.Kills >= 5 && m_TargetMap != Map.Felucca) || ( m_TargetMap == Map.Tokuno && (flags & ClientFlags.Tokuno) == 0 ) || ( m_TargetMap == Map.Malas && (flags & ClientFlags.Malas) == 0 ) || ( m_TargetMap == Map.Ilshenar && (flags & ClientFlags.Ilshenar) == 0 ) )
			{
