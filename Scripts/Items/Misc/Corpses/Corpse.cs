...
namespace Server.Items
{
    ...
    public enum CorpseFlag
    {
        ...
        /// <summary>
        /// Was the owner of the corpse a creature?
        /// </summary>
        CreatureCorpse = 0x00000040,
    ...
    public class Corpse : Container, ICarvable
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool CreatureCorpse
        {
            get { return GetFlag(CorpseFlag.CreatureCorpse); }
            set { SetFlag(CorpseFlag.CreatureCorpse, value); }
        }
        ...
        public override void OnAfterDelete()
        {
            ...
            EventDispatcher.InvokeCorpseAction(new CorpseActionEventArgs(null, this, CorpseActionEventArgs.CorpseAction.Deleted));
        }
            ...
            : base(0x2006)
        {
            ...
            SetFlag(CorpseFlag.CreatureCorpse, isBaseCreature);
        ...
        public override void OutOfRange( Mobile from )
        {
            base.OutOfRange(from);

            if( from.Player )
            {
                EventDispatcher.InvokeCorpseAction(new CorpseActionEventArgs((Player)from, this, CorpseActionEventArgs.CorpseAction.Closed));
            }
        }
        ...
        public void Carve( Mobile from, Item item )
        {
            ...
            if( from.Player )
            {
                EventDispatcher.InvokeCorpseAction(new CorpseActionEventArgs((Player)from, this, CorpseActionEventArgs.CorpseAction.Carved));
            }
        }
    }
}