...
{
	public class RangerCorpse : Corpse
	{
		...
		private static System.Collections.Generic.List<Item> GetEquipment()
		{
			...
			list.Add( new RangerChest() );
			list.Add( new RangerGorget() );
			list.Add( new RangerLegs() );
			list.Add( new RangerGloves() );
			list.Add( new RangerArms() );
			list.Add( new Boots() );
			...
			switch( Utility.Random( 4 ) )
			{
				...
				case 1:
					{
						list.Add( new CompositeBow() );
						break;
					}
				case 2:
					{
						list.Add( new RepeatingCrossbow() );
						break;
					}
				case 3:
					{
		...
		public RangerCorpse( Serial serial )
			: base( serial )
		{
		}
