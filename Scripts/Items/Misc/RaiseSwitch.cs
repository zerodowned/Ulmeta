...
namespace Server.Items
{
	public class RaiseSwitch : Item
	{
		...
		public int NormalID
		{
			get { return m_NormalID; }
			set { m_NormalID = value; }
		}
		...
		[Constructable]
		public RaiseSwitch( int normalID, int switchedID )
			: this( normalID )
		{
			m_NormalID = normalID;
			m_SwitchedID = switchedID;
		}
		...
		{
			if( IsChildOf( m.Backpack ) ) { m.PlaySound( 0x3E8 ); }

			else if( !m.InRange( this, 2 ) )
			{
