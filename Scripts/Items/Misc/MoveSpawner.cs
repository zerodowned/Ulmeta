...
namespace Server.Items
{
	public class MoveSpawner : Item
	{
		...
		[Constructable]
		public MoveSpawner()
			: this( null, null, 1, 1, 4, 0, TimeSpan.FromMinutes( 5 ), false )
		{
		}

		[Constructable]
		public MoveSpawner( string creature )
			: this( creature, null, 1, 1, 4, 0, TimeSpan.FromMinutes( 5 ), true )
		{
		}

		[Constructable]
		public MoveSpawner( string creature, string msg )
			: this( creature, msg, 1, 1, 4, 0, TimeSpan.FromMinutes( 5 ), true )
		{
		}

		[Constructable]
		public MoveSpawner( string creature, string msg, int limit )
			: this( creature, msg, limit, 1, 4, 0, TimeSpan.FromMinutes( 5 ), true )
		{
		}

		[Constructable]
		public MoveSpawner( string creature, string msg, int limit, double chance )
			: this( creature, msg, limit, chance, 4, 0, TimeSpan.FromMinutes( 5 ), true )
		{
		}

		[Constructable]
		public MoveSpawner( string creature, string msg, int limit, int range, int team )
			: this( creature, msg, limit, 1, range, team, TimeSpan.FromMinutes( 5 ), true )
		{
		}

		[Constructable]
		public MoveSpawner( string creature, string msg, int limit, double chance, int range, int team )
			: this( creature, msg, limit, chance, range, team, TimeSpan.FromMinutes( 5 ), true )
		{
		}

		public MoveSpawner( string creature, string msg, int limit, double chance, int range, int team, TimeSpan delay, bool active )
			: base( 0x1B72 )
		{
			Movable = false;
			Visible = false;
