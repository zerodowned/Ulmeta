...
namespace Server.Items
{
	public class StatCapScroll : SpecialScroll
	{
		...
		public override string DefaultTitle { get { return String.Format( "<basefont color=#FFFFFF>Power Scroll ({0}{1} Maximum Stats):</basefont>", ( (int)Value - 325 ) >= 0 ? "+" : "", (int)Value - 325 ); } }
		...
		public override void AddNameProperty(ObjectPropertyList list)
		{
            ...
            //else
			list.Add( "a scroll of power ({0}{1} Maximum Stats)", (Value - 325) >= 0 ? "+" : "", Value - 325 );
		}
		...
		public override void OnSingleClick( Mobile from )
		{
            ...
            //else
				base.LabelTo( from, "a scroll of power ({0}{1} Maximum Stats)", (Value - 325) >= 0 ? "+" : "", Value - 325 );
		}
