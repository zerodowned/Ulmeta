	...
	public class PowerScroll : SpecialScroll
	{
		...
		*/
		...
		public override void Use( Mobile from )
		{
            ...
            from.SendMessage("You feel a surge of magic as the scroll enhances your " + from.Skills[Skill].Name); // You feel a surge of magic as the scroll enhances your ~1_type~!
