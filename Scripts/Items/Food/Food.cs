...
namespace Server.Items
{
    public abstract class Food : Item
    {
        ...
        private int _levelOfRot;

        public class DecayTimer : Timer
        {
            Food FoodObject;
            public DecayTimer(TimeSpan delay, Food food)
                : base(delay)
            {
                FoodObject = food;
            ...
            protected override void OnTick()
            {
                ...
                if (FoodObject.RotLevel > 4)
                    FoodObject.Hue = Utility.RandomSlimeHue();

                if (FoodObject.RotLevel < 10)
                    Start();
            }
        }
        ...
        public int RotLevel
        {
            get { return _levelOfRot; }
            set { _levelOfRot = value; }
        }
            ...
            : base(itemID)
        {
            ...
            DecayTimer timer = new DecayTimer
                (TimeSpan.FromHours(12), this);
            timer.Start();
        }
