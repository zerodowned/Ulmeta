...
namespace Server.Items
{
    ...
    public abstract class BaseBeverage : Item, IDescriptiveItem, IHasQuantity
    {
        ...
        public virtual void Pour_OnTarget( Mobile from, object targ )
        {
            ...
            else if( from == targ )
            {
                ...
                if( from.Player )
                {
                    EventDispatcher.InvokePlayerDrinking(new PlayerDrinkingEventArgs((Player)from, this));
                }
        ...
        #region IDescriptiveItem members
