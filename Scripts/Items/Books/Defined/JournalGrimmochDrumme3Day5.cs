...
{
	public class JournalGrimmochDrumme3Day5 : BrownBook
	{
		[Constructable]
		public JournalGrimmochDrumme3Day5() : base( "The daily journal of Grimmoch Drummel", "Grimmoch ", 6, false ) // true writable so players can make notes
		{
		...
		public JournalGrimmochDrumme3Day5( Serial serial ) : base( serial )
		{
		}
