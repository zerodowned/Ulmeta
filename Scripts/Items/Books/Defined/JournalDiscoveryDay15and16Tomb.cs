...
namespace Server.Items
{
	...
	{
		[Constructable]
		public JournalDiscoveryDay15and16Tomb()
			: base( "Journal: Discovery of the Tomb", "Tawara Sewel ", 7, false ) // true writable so players can make notes
		{
		...
		public JournalDiscoveryDay15and16Tomb( Serial serial )
			: base( serial )
		{
		}
