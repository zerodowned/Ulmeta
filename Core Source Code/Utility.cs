...
#pragma warning restore 618
		...
		*/
        ...
        private static int[] HairValues = new int[]
			{
				0x203D, 0x203C, 0x203D, 0x2044, 0x2045, 0x2046,
				0x2047, 0x2048, 0x2049, 0x204A
			};

        private static int[] FacialHairValues = new int[]
			{
        ...
        {
            m.HairItemID = Utility.RandomList(HairValues);
            m.HairHue = hue;
        }
        ...
        public static void AssignRandomFacialHair( Mobile m, int hue )
        {
            ...
            m.FacialHairItemID = Utility.RandomList(FacialHairValues);
            m.FacialHairHue = hue;
        }
