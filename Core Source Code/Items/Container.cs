    ...
    public class Container : Item
    {
        ...
        public override void OnSingleClick( Mobile from )
        {
            ...
            if( CheckContentDisplay(from) )
                LabelTo(from, "({0} items, {1} pounds)", TotalItems, (TotalWeight / 2));
        }
        ...
        /// <summary>
        /// Invoked when a <code>Mobile</code> has moved out of range of the container
        /// </summary>
        public virtual void OutOfRange( Mobile from )
        {
        }
    }
